							...
							<div class="main-menu stellarnav z-0">
								<ul class="menu-list">
									...
									<li class="menu-item has-sub">
										...
										<ul>
											<li class="active"><a href="{{asset('booksaw/index.html') }}">Home</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">About</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">Styles</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">Blog</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">Post Single</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">Our Store</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">Product Single</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">Contact</a></li>
											<li><a href="{{asset('booksaw/index.html') }}">Thank You</a></li>
										</ul>
			...
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-5">
							<figure>
								<img src="{{ asset('booksaw/images/device.png') }}" alt="phone" class="single-image">
							</figure>
						</div>
						...
						<div class="col-md-7">
							<div class="app-info">
								...
								<div class="google-app">
									<img src="{{ asset('booksaw/images/google-play.jpg') }}" alt="google play">
									<img src="{{ asset('booksaw/images/app-store.jpg') }}" alt="app store">
								</div>
							</div>
						</div>
